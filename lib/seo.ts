function normalizeSiteUrl(value: string | undefined) {
  const fallback = "https://wl-colchoes-site.vercel.app";
...
export const siteConfig = {
  ...
  keywords: [
    "reforma de colchão",
    "reforma de colchão em Recife",
    "reforma de colchão em Olinda",
    "reforma de colchão em Paulista",
    "conserto de colchão",
    "restauração de colchão",
    "troca de espuma de colchão",
    "troca de tecido de colchão",
    "colchão reformado",
    "colchão sob medida",
    "reforma de colchão magnético",
  ],
